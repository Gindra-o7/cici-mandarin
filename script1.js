...
const imageSourcesService1 = [
    '/asset/service1Carousel/1.png',
    '/asset/service1Carousel/2.png',
    '/asset/service1Carousel/3.png',
];
...
function renderCarouselImages(imageSources, carouselContainer, startIndex = 0) {
    ...
    try {
        ...
        imageSources.forEach((src, index) => {
            const carouselItem = document.createElement('div');
            carouselItem.classList.add('carousel-itemService');
            const actualIndex = (index + startIndex) % imageSources.length;
            const image = document.createElement('img');
            image.src = imageSources[actualIndex];
            image.alt = `Service ${actualIndex + 1}`;
...
// Event listener for the "next" button
if (nextService && carouselContainer) {
...
if (prevService && carouselContainer) {
...
const imageSourcesService2 = [
    '/asset/service2Carousel/1.png',
    '/asset/service2Carousel/2.png',
    '/asset/service2Carousel/3.png',
    '/asset/service2Carousel/4.png',
];

let startIndexService2 = 0; // Starting index

if (window.location.pathname.endsWith('service2.html')) {
// Get the carousel container element
    const carouselContainer = document.querySelector('.carouselService');
...
const imageSourcesService3 = [
    '/asset/service3Carousel/1.png',
    '/asset/service3Carousel/2.png',
    '/asset/service3Carousel/3.png',
];
